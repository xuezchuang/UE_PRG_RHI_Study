...
//void FRenderTestViewportClient::DrawCanvas(FViewport& InViewport, FSceneView& View, FCanvas& Canvas)
//{
...
//		FVector2D V1 = FVector2D(InViewport.GetSizeXY().X - 100, 100);  // 顶点2
//		FVector2D V2 = FVector2D(InViewport.GetSizeXY().X / 2, InViewport.GetSizeXY().Y - 100);  // 顶点3
//
//		// 定义每个顶点的颜色
...
//		//FCanvasTileItem Tile(FVector2D::ZeroVector, RenderTarget->GetResource(), InViewport->GetSizeXY(), FLinearColor::White);
//
...
//	{
//		FCanvasTileItem Tile(FVector2D::ZeroVector, InTexture->GetResource(), InViewport.GetSizeXY(), FLinearColor::Black);
//		Canvas.DrawItem(Tile);
//	}
//
//	//FCanvasLineItem Line(FVector2D(100, 100), FVector2D(InViewport->GetSizeXY().X - 100, InViewport->GetSizeXY().Y - 100));
...
//	//	Canvas->DrawItem(Tile);
//
//	//	//FCanvasLineItem tLine(FVector2D(100, 100), FVector2D(InViewport->GetSizeXY().X-100, InViewport->GetSizeXY().Y-100));
...
//	//renderer.Render(RenderTarget);
//	//FCanvasTileItem Tile(FVector2D::ZeroVector, RenderTarget->Resource, InViewport->GetSizeXY(), FLinearColor::White);
//	//Canvas->DrawItem(Tile);
//}
